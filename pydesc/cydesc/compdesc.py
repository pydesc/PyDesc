...
class t_compdesc_parameters(ctypes.Structure):  # pylint: disable=C0103
    ...
    """
    _fields_ = [('th_zero_el_rmsd', ctypes.c_float),
...
class t_al_coverage(ctypes.Structure):  # pylint: disable=C0103
    # This class has to be named as the corresponding C structure.
    _fields_ = [('desc1', t_desc_coverage),
                ('desc2', t_desc_coverage)]


class t_alignment(ctypes.Structure):  # pylint: disable=C0103
    # This class has to be named as the corresponding C structure.
    _fields_ = [('mer_map', POINTER(t_map)),
...
class t_elsim(ctypes.Structure):  # pylint: disable=C0103
    # This class has to be named as the corresponding C structure.
    _fields_ = [('el1', POINTER(cydesc.CElement)),
...
class t_consim(ctypes.Structure):  # pylint: disable=C0103
    # This class has to be named as the corresponding C structure.
    _fields_ = [('con1', POINTER(cydesc.CContact)),
...
class t_sim_components(ctypes.Structure):  # pylint: disable=C0103
    # This class has to be named as the corresponding C structure.
    _fields_ = [('elsim_list', POINTER(t_elsim)),
...
class t_sim(ctypes.Structure):  # pylint: disable=C0103
    # This class has to be named as the corresponding C structure.
    _fields_ = [('elsim', POINTER(t_elsim)),
                ('consim', POINTER(t_consim))]


class t_sim_graph(ctypes.Structure):  # pylint: disable=C0103
    # This class has to be named as the corresponding C structure.
    _fields_ = [('sim_list', POINTER(t_sim)),
...
class t_compdesc_result(ctypes.Structure):  # pylint: disable=C0103
    ...
    """
    _fields_ = [('n_monomers', ctypes.c_int),
...
if libcompdesc.has_debug():
    libcompdesc.compdesc.argtypes = [ctypes.POINTER(cydesc.CDescriptor), ctypes.POINTER(cydesc.CDescriptor), ctypes.c_int, ctypes.POINTER(t_compdesc_parameters), ctypes.POINTER(ctypes.POINTER(t_compdesc_result)), ctypes.POINTER(ctypes.POINTER(t_compdesc_debug))]
else:
    libcompdesc.compdesc.argtypes = [ctypes.POINTER(cydesc.CDescriptor), ctypes.POINTER(cydesc.CDescriptor), ctypes.c_int, ctypes.POINTER(t_compdesc_parameters), ctypes.POINTER(ctypes.POINTER(t_compdesc_result))]
...
def _desc_setter(num):
    ...
    def set_desc(self, desc_obj):
        ...
        setattr(self, '_c_desc%d' % num, None if desc_obj is None else cydesc.CDescriptor(desc_obj))
...
class CompDesc(object):
    ...
    def compdesc(self, max_res=0, debug=False):
        ...
        n_results = libcompdesc.compdesc(self._c_desc1, self._c_desc2, max_res, pars, results_p, debug_p)

        results = [res.unpack(self.desc1, self.desc2) for res in results_p[0:n_results]]

        if debug:
            return results, debug_p.contents, results_p[0:n_results], self._c_desc1, self._c_desc2
        else:
