...
class CInDelMeta(ctypes.Structure.__class__):
    ...
    calling C functions when creating and deleting instances, and for resizing memory
    buffer to accommodate components visible only in C.
...
class CMer(ctypes.Structure, metaclass=CInDelMeta):
    """
    Class for holding monomers. Corresponds to CMer in cydesc.h
    """
