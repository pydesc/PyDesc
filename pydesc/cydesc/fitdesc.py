...
class FitDesc(object):
    ...
    def fitdesc(self, max_rmsd, max_res=0):
        ...
        n_results = libfitdesc.fitdesc(self._c_motif, self._c_structure, max_rmsd, max_res, results_p)

        results = [res.unpack(self.motif, self.structure) for res in results_p[0:n_results]]
